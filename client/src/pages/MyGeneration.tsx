...
const MyGeneration = () => {
  ...
  return (
    <div className='my-32 min-h-screen px-6 md:px-16 ld:px-24 xl:px-32'>
          ...
          <div className='columns-1 sm:columns-2 lg:columns-3 2xl:columns-4 gap-8'>
            {
              thumbnails.map((thumb:IThumbnail)=>{
                ...
                return(
                  <div key={thumb._id} className='mb-8 group relative cursor-pointer rounded-2xl bg-white/6 border-white/10 transition shadow-xl break-inside-avoid' onClick={()=>navigate(`/generate/${thumb._id}`)} >
